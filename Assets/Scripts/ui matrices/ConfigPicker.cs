...
namespace UIMatrices {
    ...
    public class ConfigPicker : MonoBehaviour {
        ...
        private static ConfigPicker instance;
        ...
        bool initialized;
        System.Action<MatrixConfig> currentOnPickAction;
        ...
        void Initialize () {
            ...
            if(instance != null){
                Debug.LogError($"Singleton violation! Instance of {nameof(ConfigPicker)} wasn't null! Aborting...");
                return;
            }
            instance = this;
            ...
            var configTypes = System.Enum.GetValues(typeof(MatrixConfig.Type));
        ...
        void Unhide (System.Action<MatrixConfig> onConfigPicked, float scale) {
        ...
        void ButtonClicked (MatrixConfig config) {
        ...
        private class BackgroundRaycastCatcher : MonoBehaviour, IPointerClickHandler {
            private ConfigPicker parent;
            public void Initialize (ConfigPicker parent) {
                this.parent = parent;
            }
