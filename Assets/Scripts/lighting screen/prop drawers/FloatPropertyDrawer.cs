...
namespace LightingModels {
    ...
    public class FloatPropertyDrawer : UIPropertyDrawer {
        ...
        public void Initialize (ShaderProperty prop, System.Action<float> onValueChanged, System.Func<float, string> formatString) {
            Initialize(
                labelText: prop.niceName,
                initValue: prop.defaultValue,
                initMin: prop.minValue,
                initMax: prop.maxValue,
                clampInputField: false,
                onValueChanged: onValueChanged,
                formatString: formatString
            );
        }

        public void Initialize (string labelText, float initValue, float initMin, float initMax, bool clampInputField, System.Action<float> onValueChanged, System.Func<float, string> formatString) {
